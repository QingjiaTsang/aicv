...
export const Route = createFileRoute('/(auth)/preview/$document-id')({
...
function RouteComponent() {
  ...
  const { data: document } = useSuspenseQuery(publicDocumentQueryOptionsFn(params["document-id"]));
...
export function DocumentPreviewHeader({ title, className }: DocumentPreviewHeaderProps) {
  return (
    <div className={cn(
